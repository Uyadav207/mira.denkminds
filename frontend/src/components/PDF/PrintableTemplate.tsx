			...
			>
					...
					<div className="flex justify-between items-center">
						...
						<div className="text-center my-8">
							<h1 className="text-3xl font-bold">
								{templateId
									? `Detailed Report For: ${templateId}`
									: "Loading Template..."}
							</h1>
						</div>
				...
				<div className="avoid-break">
					...
					<ul className="list-disc pl-5">
						...
						<li>
							The recent Dynamic Application Security Testing
							(DAST) scan conducted on the application hosted at
							https://denkminds.vercel.app has provided valuable
							insights into the security posture of the web
							application.
						</li>
