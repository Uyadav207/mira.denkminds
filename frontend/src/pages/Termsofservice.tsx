				...
				<Card className="shadow-lg max-w-6xl mx-auto">
					...
					<CardContent>
						<div className="prose max-w-none">
							...
							<p>
								By using any of our services, you acknowledge and agree to these
								Terms of Service and our Privacy Policy. We may update these
								terms from time to time, and we will notify you of significant
								changes. Continued use of our services after such updates will
							...
							<p>
								...
								form a binding contract in your jurisdiction. By using our
							...
							<p>
								denkMinds offers various products and services, including but
								not limited to digital platforms, tools, and collaborative
								projects aimed at promoting learning and knowledge sharing. We
								may add or remove services at any time at our sole discretion.
							</p>{" "}
							<br />
							<h2>
							...
							<p>
								...
								information during registration and keep your account details
								secure.
							</p>{" "}
							<br />
							<h2>
							...
							<p>
								...
								laws and regulations and not engage in any activity that could
								harm, disable, or impair the functionality of our services.
							</p>{" "}
							<br />
							<h2>
							...
							<p>
								All content, logos, and trademarks displayed on our platforms
								are the property of denkMinds or its licensors. You may not
							...
							<p>
								To the fullest extent permitted by law, denkMinds shall not be
