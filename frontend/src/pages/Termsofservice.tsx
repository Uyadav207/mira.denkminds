			...
			<Card className="shadow-lg max-w-6xl mx-auto">
				...
				<CardContent>
					<div className="prose max-w-none">
						...
						<p>
							By using any of our services, you acknowledge and
							agree to these Terms of Service and our Privacy
							Policy. We may update these terms from time to time,
							and we will notify you of significant changes.
							Continued use of our services after such updates
							will constitute your acceptance of the modified
							terms.
						</p>
						<br />
						<h2>
						...
						<p>
							...
							capacity to form a binding contract in your
							jurisdiction. By using our services, you represent
						...
						<p>
							...
							tools, and collaborative projects aimed at promoting
							learning and knowledge sharing. We may add or remove
						...
						<p>
							By using our services, you agree to comply with all
							applicable laws and regulations and not engage in
							any activity that could harm, disable, or impair the
						...
						<p>
							...
							for detailed information about how we collect, use,
						...
						<p>
							...
							unauthorized purpose or interfere with the integrity
						...
						<p>
							All content, logos, and trademarks displayed on our
							platforms are the property of denkMinds or its
							licensors. You may not reproduce, distribute, or
							create derivative works without prior written
							consent.
						</p>{" "}
						<br />
						<h2>
						...
						<p>
							...
							access to our services at our sole discretion, with
						...
						<p>
							To the fullest extent permitted by law, denkMinds
